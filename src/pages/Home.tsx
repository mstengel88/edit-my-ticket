    ...
    <AppLayout title="Home" subtitle="Ticketing operations at a glance">
      <div className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 xl:px-8">
        <div className="grid gap-6 xl:grid-cols-[1.7fr_1fr]">
          <section className="console-panel border-cyan-300/10 bg-[linear-gradient(135deg,rgba(21,39,60,0.98),rgba(12,21,34,0.98))] p-6 shadow-2xl">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-2xl space-y-3">
                ...
                <div>
                  ...
                  <p className="console-copy mt-3 max-w-xl sm:text-base">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              {kpis.map((item) => (
                <div
                  key={item.label}
                  className="console-kpi backdrop-blur-sm"
                >
                  <div className="flex items-center justify-between">
                    <p className="console-eyebrow text-slate-400">{item.label}</p>
          ...
          <section className="console-panel bg-[#121c2c] p-6 shadow-2xl">
            <div className="flex items-center justify-between gap-3">
              <div>
                <p className="console-eyebrow">Quick Access</p>
            ...
            <div className="mt-5 space-y-3">
              {[
                ...
                <Link
                  key={item.href}
                  to={item.href}
                  className="console-panel-soft group block px-4 py-4 transition-colors hover:bg-white/[0.06]"
                >
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
          <section className="console-panel bg-[#121c2c] p-5">
            <div className="flex items-center justify-between gap-3">
              <div>
                <p className="console-eyebrow">Live Queue</p>
            ...
            <div className="mt-5 space-y-3">
              ...
              {recentTickets.map((ticket) => (
                <div
                  key={ticket.id}
                  className="console-panel-soft grid gap-3 px-4 py-4 md:grid-cols-[1.2fr_1fr_auto]"
                >
          ...
          <section className="grid gap-6">
            <div className="console-panel bg-[#121c2c] p-5">
              <p className="console-eyebrow">Top Customers</p>
              ...
              <div className="mt-5 space-y-3">
                ...
                {topCustomers.map(([name, count]) => (
                  <div key={name} className="console-panel-soft flex items-center justify-between px-4 py-3">
                    <div className="min-w-0">
            ...
            <div className="console-panel bg-[#121c2c] p-5">
              <p className="console-eyebrow">Workflow</p>
              ...
              <div className="mt-5 space-y-3">
                {[
                  ...
                  <div key={step} className="console-panel-soft flex gap-3 px-4 py-3">
